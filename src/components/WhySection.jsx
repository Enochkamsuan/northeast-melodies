...
const ITEMS = [
  {
    icon: Mountain,
    title: "Made for the Hills",
    text: "Built around Northeast dialects you won't find on mainstream platforms.",
  },
  {
    icon: Headphones,
    title: "Smart Discovery",
    text: "Filter by mood, dialect and genre — find a song that fits the moment.",
  },
  {
    icon: Globe2,
    title: "Cultural First",
    text: "Every playlist celebrates a community, language and tradition.",
  },
  {
    icon: Heart,
    title: "Artist Friendly",
    text: "Designed to lift independent voices from across the seven sisters.",
  },
];
    ...
    <section className="mx-auto max-w-7xl px-6 py-20">
      <div className="text-center">
        <h2 className="text-3xl font-bold sm:text-4xl">
          Why <span className="text-gradient">LairikBeats</span>
        </h2>
